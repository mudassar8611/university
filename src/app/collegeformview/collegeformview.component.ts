...
@Component({
  selector: 'app-collegeformview',
  templateUrl: './collegeformview.component.html',
  styleUrls: ['./collegeformview.component.css']
})
export class CollegeformviewComponent implements OnInit {
